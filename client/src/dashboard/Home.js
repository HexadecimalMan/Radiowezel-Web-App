                ...
                <div class="col-lg-4">
                    <div class="card text-center pb-4">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Artykuły i aktualności</h5>
                            <p class="card-text">Dodaj, edytuj i usuwaj aktualności, artykuły <br />i wiadomości w zakładce Aktualności.</p>
                            <Link to="/dashboard/news" style={linkStyle}><a class="btn btn-secondary" href="#">Przejdź do sekcji &raquo;</a></Link>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card text-center pb-4">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Zgłoszone piosenki</h5>
                            <p class="card-text">Zarządzaj zgłoszonymi piosenkami <br /> i dodaj je do odpowiedniej playlisty.</p>
                            <Link to="/dashboard/news" style={linkStyle}><a class="btn btn-secondary" href="#">Przejdź do sekcji &raquo;</a></Link>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card text-center pb-4">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Zamówione dedykacje</h5>
                            <p class="card-text">Zobacz kalendarz dedykacji i zarządzaj nimi <br /> oraz dodatkowymi ustawieniami.</p>
                            <Link to="/dashboard/news" style={linkStyle}><a class="btn btn-secondary" href="#">Przejdź do sekcji &raquo;</a></Link>
                        </div>
                    </div>
                </div>
